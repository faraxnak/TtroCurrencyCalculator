#
#  Be sure to run `pod spec lint TtroCurrencyCalculator.podspec' to ensure this is a
...
s.author             = { "MFA" => "mf.azampour@gmail.com" }
...
s.source       = { :git => "https://github.com/faraxnak/TtroCurrencyCalculator.git", :tag => "#{s.version}" }
